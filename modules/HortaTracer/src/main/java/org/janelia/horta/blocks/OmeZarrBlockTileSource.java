...
public class OmeZarrBlockTileSource implements BlockTileSource<OmeZarrBlockTileKey> {
    ...
    public OmeZarrBlockTileSource init(TmSample sample) throws IOException {
        this.sampleOmeZarrTilesBaseDir =
    ...
    private void init() {
        ...
        for (int idx = datasetCount - 1; idx >= 0; idx--) {
            try {
                ...
                OmeZarrBlockResolution resolution = new OmeZarrBlockResolution(idx, shape, resolutionMicrometers, 0);
                ...
                if (resolutionMicrometers < MAX_BLOCKING_RESOLUTION) {
                    ...
                    resolution = new OmeZarrBlockResolution(idx, shape, resolutionMicrometers, maxBlockingResolutionIndex - idx + 1);
